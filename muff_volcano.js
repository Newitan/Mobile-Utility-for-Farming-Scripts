...
window.parent.runLoader({name:'Volcano Mining',src:'https://newitan.github.io/Mobile-Utility-for-Farming-Scripts/muff_volcano.js',com:'mineVolcano(prompt("Adventures to spend:"))'});
